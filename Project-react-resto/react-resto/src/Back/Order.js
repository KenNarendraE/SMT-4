                    ...
                    <div className="col">
                        <form onSubmit={handleSubmit(simpan)}>
                            ...
                            <div className="mb-3">
                                ...
                                <input type="submit" className="btn btn-danger ml-3" name="batal" value="batal" onClick={() => setMopen(false)} />
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <tbody>
                            {
                                isi.map((val, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>{val.kembali}</td>
                                        <td>{
                                            val.status === 0 ? <button className="btn btn-dark" onClick={() => filterData(val.idorder)}>Belum Bayar</button> : <p>Lunas</p>
                                        }</td>
                                    </tr>
                                ))
                            }
